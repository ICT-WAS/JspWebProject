...
<body class="template-color-1">
    ...
    <div class="main-wrapper">
		...
		<form action="/ShoppingMallProject/address/insert" method="post" id="myForm" novalidate>
			<div class="mb-3 mt-3">
				<label for="alias" class="form-label"><span class="required">*</span>배송지 명칭:</label> <input type="text"
					class="form-control" id="alias" name="alias" required minlength=1 maxlength=10>
			...
			<div class="mb-3 mt-3">
				<label for="recipientName" class="form-label"><span class="required">*</span>수령인:</label> <input type="text"
					class="form-control" id="recipientName" name="recipientName" required minlength=2 maxlength=10>
			...
			<div class="mb-3 mt-3">
				<label for="phoneNumber" class="form-label"><span class="required">*</span>전화번호:</label> <input type="text"
					class="form-control" id="phoneNumber" name="phoneNumber" required minlength=11 maxlength=11>
				<div class="invalid-feedback">전화번호는 010으로 시작하는 11자리의 숫자만 입력 가능합니다.</div>
			</div>
			<div class="row mb-3 mt-3">
			<label for="address" class="form-label">주소:</label>
			    <div class="col">
			      <input type="text" id="postalCode" class="form-control" placeholder="우편번호" name="postalCode" readonly="readonly" required>
			      <div class="invalid-feedback">배송지를 선택해주세요.</div>
			    </div>
			    <div class="col">
			      <input type="text" id="roadNameAddress" class="form-control" placeholder="도로명 주소" name="roadNameAddress" readonly="readonly" required>
